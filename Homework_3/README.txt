# Домашнее задание №3
Реализовать частичный аналог консольной утилиты uniq на python.
Эта утилита выводит только первую из повторяющихся строк в файле.
...
В программе должна использовать знания, которые вы получили из 3,4 лекций (Структуры данных, ООП), протестирована различными edge кейсами, оформлена в соответствии с PEP8.
